...
describe("Ranges", () => {
  it("should validate correctly inserting ranges", () => {
    ...
    expect(validateRange({ start: new Time(18, 30), end: new Time(19) }, schedules)).toBe(false);
    expect(validateRange({ start: new Time(18, 31), end: new Time(19) }, schedules)).toBe(true);
    expect(validateRange({ start: new Time(13, 1), end: new Time(13, 59) }, schedules)).toBe(true);
