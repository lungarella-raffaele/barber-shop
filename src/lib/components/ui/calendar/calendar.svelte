            ...
            {#each month.weeks as weekDates, i (i)}
              <Calendar.GridRow class="mt-1 flex w-full">
                {#each weekDates as date, i (i)}
                  ...
                  >
                    <Calendar.Day
                      class="group text-foreground not-data-selected:hover:bg-gray-2 data-selected:bg-foreground data-selected:text-background data-selected:hover:bg-foreground/90 data-disabled:text-muted-foreground data-unavailable:text-muted-foreground data-outside-month:not-data-selected:text-muted-foreground relative inline-flex size-10 items-center justify-center rounded-xl border border-transparent bg-transparent p-0 typo-label whitespace-nowrap select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-outside-month:pointer-events-none data-unavailable:line-through"
                    >
                      <span
