<script lang="ts" module>
  ...
  export const inputGroupAddonVariants = tv({
    base: "text-muted-foreground **:data-[slot=kbd]:bg-muted-foreground/10 h-auto gap-2 py-2 typo-label group-data-[disabled=true]/input-group:opacity-50 **:data-[slot=kbd]:rounded-xl **:data-[slot=kbd]:px-1.5 [&>svg:not([class*='size-'])]:size-4 flex cursor-text items-center justify-center select-none",
    variants: {
      align: {
